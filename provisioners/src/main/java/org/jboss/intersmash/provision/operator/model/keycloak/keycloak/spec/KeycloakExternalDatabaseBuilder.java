 ...
 *
 * <p>apiVersion: v1 kind: Secret metadata: name: keycloak-db-secret namespace: keycloak stringData:
 * POSTGRES_DATABASE: &lt;Database Name&gt; POSTGRES_EXTERNAL_ADDRESS: &lt;External Database IP or
 * URL (resolvable by K8s)&gt; POSTGRES_EXTERNAL_PORT: &lt;External Database Port&gt; # Strongly
 * recommended to use &lt;'Keycloak CR Name'-postgresql&gt; POSTGRES_HOST: &lt;Database Service
 * Name&gt; POSTGRES_PASSWORD: &lt;Database Password&gt; # Required for AWS Backup functionality
 * POSTGRES_SUPERUSER: true POSTGRES_USERNAME: &lt;Database Username&gt; type: Opaque
 *
