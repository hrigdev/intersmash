...
@Slf4j
public class Eap7LegacyS2iBuildTemplateProvisionerFactory
		implements ProvisionerFactory<Eap7LegacyS2iBuildTemplateProvisioner> {
	...
	public Eap7LegacyS2iBuildTemplateProvisioner getProvisioner(Application application) {
		if (Eap7LegacyS2iBuildTemplateApplication.class.isAssignableFrom(application.getClass()))
			return new Eap7LegacyS2iBuildTemplateProvisioner(
					(Eap7LegacyS2iBuildTemplateApplication) application);
		return null;
	}
}
