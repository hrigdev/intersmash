...
public class Info {
	...
	/** Unique identifier for the run, by convention 4 upper-case hexadecimal digits. (Required) */
	@JsonProperty("id")
	@JsonPropertyDescription("Unique identifier for the run, by convention 4 upper-case hexadecimal digits.")
	private String id;
	/** Name of the executed benchmark. (Required) */
	@JsonProperty("benchmark")
	@JsonPropertyDescription("Name of the executed benchmark.")
	private String benchmark;
	/**
	 * Run start time in epoch milliseconds, or negative value if the run did not start. (Required)
	 */
	@JsonProperty("startTime")
	@JsonPropertyDescription("Run start time in epoch milliseconds, or negative value if the run did not start.")
	private Long startTime;
	/**
	 * Run end time in epoch milliseconds, or negative value if the run did not complete. (Required)
	 */
