...
@JsonPropertyOrder({ "phase", "metric", "start", "end", "summary", "custom" })
...
public class PhaseStats {
	...
	/** Phase start timestamp, in epoch milliseconds. (Required) */
	@JsonProperty("start")
	@JsonPropertyDescription("Phase start timestamp, in epoch milliseconds.")
	private Long start;
	/** Phase completion timestamp, in epoch milliseconds. (Required) */
	@JsonProperty("end")
