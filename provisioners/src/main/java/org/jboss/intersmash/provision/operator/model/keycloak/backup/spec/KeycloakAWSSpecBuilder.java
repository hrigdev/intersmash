...
/**
 * If provided, an automatic database backup will be created on AWS S3 instead of a local Persistent
 * Volume. If this property is not provided - a local Persistent Volume backup will be chosen.
 */
public final class KeycloakAWSSpecBuilder {
	...
	/**
	 * If provided, the database backup will be encrypted. Provides a secret name used for encrypting
	 * database data. The secret needs to be in the following form:
	 *
	 * <p>apiVersion: v1 kind: Secret metadata: name: &lt;Secret name&gt; type: Opaque stringData:
	 * GPG_PUBLIC_KEY: &lt;GPG Public Key&gt; GPG_TRUST_MODEL: &lt;GPG Trust Model&gt; GPG_RECIPIENT:
	 * &lt;GPG Recipient&gt;
	 *
	...
	/**
	 * Provides a secret name used for connecting to AWS S3 Service. The secret needs to be in the
	 * following form:
	 *
	 * <p>apiVersion: v1 kind: Secret metadata: name: &lt;Secret name&gt; type: Opaque stringData:
	 * AWS_S3_BUCKET_NAME: &lt;S3 Bucket Name&gt; AWS_ACCESS_KEY_ID: &lt;AWS Access Key ID&gt;
