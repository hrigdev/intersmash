...
/**
 * A contract that defines data that an WILDFLY Helm Chart provisioned application service should
 * expose
 */
public interface WildflyHelmChartOpenShiftApplication extends HelmChartOpenShiftApplication {
	 ...
	 *
	 * @return A string representing the builder image that will be used by the WILDFLY Helm Charts
	 *     release
	 */
	 ...
	 *
	 * @return A string representing the runtime image that will be used by the WILDFLY Helm Charts
	 *     release
	 */
