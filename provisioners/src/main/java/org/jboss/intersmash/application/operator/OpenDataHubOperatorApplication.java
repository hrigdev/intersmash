 ...
 *
 * <ul>
 *   <li>{@link org.jboss.intersmash.provision.operator.OpenDataHubOperatorProvisioner}
 * </ul>
 */
public interface OpenDataHubOperatorApplication extends OperatorApplication {
	...
	/**
	 * Provides read access to the {@link DSCInitialization} instance that should be used to
	 * initialize the deployed {@link DataScienceCluster}, represented by {@link
	 * #getDataScienceCluster} getter.
	 *
	 * @return A {@link DSCInitialization} instance that configures the deployed {@link
	 *     DataScienceCluster}
	 */
