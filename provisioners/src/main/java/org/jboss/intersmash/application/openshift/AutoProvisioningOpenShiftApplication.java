 ...
 *
 * <p>Concrete implementations of this interface implement the various steps of the provisioning
 * workflow through their own methods.
 */
public interface AutoProvisioningOpenShiftApplication extends OpenShiftApplication {
	 ...
	 *
	 * @param replicas Integer, the number of desired replicas after the scaling operation has
	 *     completed
