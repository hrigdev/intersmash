...
public class Route implements io.fabric8.kubernetes.api.model.KubernetesResource {
	...
	/**
	 * Host for the route leading to Controller REST endpoint. Example:
	 * hyperfoil.apps.cloud.example.com
	 */
	...
	/**
	 * Optional for edge and reencrypt routes, required for passthrough; Name of the secret hosting
