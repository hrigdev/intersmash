...
/**
 * Providers serving Application implementing this interface are capable of managing the Secret
 * resources.
 *
...
public interface HasSecrets {
	...
	/**
	 * Get {@link Secret} objects associated with an application. It's a task for provider to deploy
	 * and undeploy the resource on tested cluster as a part of standard application lifecycle.
	 *
